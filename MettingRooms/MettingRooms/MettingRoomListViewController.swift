//
//  MettingRoomListViewController.swift
//  MettingRooms
//
...
class MettingRoomListViewController: UITableViewController {
    var meetingRooms: [String:[String:Int]] = [
        "Meeting":["Banksy":4,"Rivera":8,"Kahlo":8,"Picasso":10]
        ,"Seminar":["Cezanne":20,"Matisse":30,"Renoir":40]
    ]
    ...
    override func viewDidLoad() {
        ...
        // Uncomment the following line to display an Edit button in the navigation bar for this view conntroller.
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        let categoryValue = Array(meetingRooms.values)[section]
